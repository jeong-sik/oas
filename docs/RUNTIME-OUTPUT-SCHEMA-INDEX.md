...
| `oas.harness_report.v1` | Harness report JSON/Markdown/JUnit artifacts | `lib/harness_report.mli` | Harness runner report tests |
| `oas.eval_report.v1` | Evaluation report JSON/text section | `lib/eval_report.mli` | Eval report and baseline tests |
