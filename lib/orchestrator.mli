...
val step_as_tool : name:string -> description:string -> step -> Tool.t

(** Wrap an {!Agent.t} as a step via {!Agent_tool.agent_runner}. *)
val agent_as_step : sw:Eio.Switch.t -> ?clock:_ Eio.Time.clock -> Agent.t -> step
