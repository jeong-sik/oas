...
type worker_metric = {
  diversity: float;
  (** unique_tools / total_calls.  Higher = more exploratory. *)
...
type thresholds = {
  ...
  (** >= this is considered diverse (default 0.3) *)
  diversity_scripted: float;
  (** < this is considered scripted (default 0.15) *)
  divergence_autonomous: float;
  (** >= this is considered divergent (default 0.15) *)
