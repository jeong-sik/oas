...
val prompt_of_messages : ?include_tool_blocks:bool -> Types.message list -> string
...
val system_prompt_of : req_config:Provider_config.t -> Types.message list -> string option
