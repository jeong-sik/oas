...
## [0.227.0](https://github.com/jeong-sik/oas/compare/v0.228.0...v0.227.0) (2026-07-27)
...
* make exact preference recovery evidence-owned ([#2815](https://github.com/jeong-sik/oas/issues/2815))
...
* drop Pending_input_updated, with_backtrace, and duplicate fresh_id ([#2726](https://github.com/jeong-sik/oas/issues/2726))
...
* add affine exact-output call identity ([#2776](https://github.com/jeong-sik/oas/issues/2776)) ([d2d79e1](https://github.com/jeong-sik/oas/commit/d2d79e172dfd6523d765bc4feba331338c4a913a))
...
* **agent:** add typed cooperative tool-boundary yield ([#2597](https://github.com/jeong-sik/oas/issues/2597)) ([160670e](https://github.com/jeong-sik/oas/commit/160670e22676d8d849dd80b5330f67e35ac51e87))
...
* **exact-output:** add durable domain settlement ([#2813](https://github.com/jeong-sik/oas/issues/2813)) ([ccb2dd7](https://github.com/jeong-sik/oas/commit/ccb2dd73353c05aff3627cc7bbabfdcc4e95ad10))
...
* **exact-output:** document measurement receipt hard cut ([#2823](https://github.com/jeong-sik/oas/issues/2823)) ([ca5ce0e](https://github.com/jeong-sik/oas/commit/ca5ce0e36ad7768fe29db857e60039a64bfc0192))
...
* make exact preference recovery evidence-owned ([#2815](https://github.com/jeong-sik/oas/issues/2815)) ([e591b5d](https://github.com/jeong-sik/oas/commit/e591b5dfdc95cad27bbe26f81462713b28ac1aab))
...
* **agent:** disambiguate recovery records ([#2545](https://github.com/jeong-sik/oas/issues/2545)) ([aded6b6](https://github.com/jeong-sik/oas/commit/aded6b65c4ff7abbc830edb2e57c0000c8519a95))
...
* **ci:** restore OAS 0.209 main build ([#2511](https://github.com/jeong-sik/oas/issues/2511)) ([3f05a4f](https://github.com/jeong-sik/oas/commit/3f05a4f95c3c49c971c95cce053bc41070c9514c))
...
* **defaults:** stop falling back to local provider ([#2442](https://github.com/jeong-sik/oas/issues/2442)) ([89e77af](https://github.com/jeong-sik/oas/commit/89e77af45000c4d029cd0080c2ac233751054151))
...
* **events:** redact recovery control payloads ([#2555](https://github.com/jeong-sik/oas/issues/2555)) ([1226d1f](https://github.com/jeong-sik/oas/commit/1226d1fc38e8be923e9051aa77a169e43c5d6ff2))
...
* **gemini:** restore signature role error message ([#2567](https://github.com/jeong-sik/oas/issues/2567)) ([16e72ec](https://github.com/jeong-sik/oas/commit/16e72ec609e455419641f0ec0b05df4fc13034d4))
...
* **llm_provider:** bound OAS wire capture file growth ([#2448](https://github.com/jeong-sik/oas/issues/2448)) ([3843c89](https://github.com/jeong-sik/oas/commit/3843c89034ca3e6b124ee8246392bc72df713fb5))
...
* **retry:** classify HTTP 413 instead of folding it into Unknown_invalid_request ([#2818](https://github.com/jeong-sik/oas/issues/2818)) ([be78ca5](https://github.com/jeong-sik/oas/commit/be78ca55cfb515d7da15a4f4682129dfc063bdf4))
* **retry:** preserve observed context overflow wire errors ([#2825](https://github.com/jeong-sik/oas/issues/2825)) ([2aa9e15](https://github.com/jeong-sik/oas/commit/2aa9e1565e66a77636c3fd8712cfe2c6661c8188))
...
* drop Pending_input_updated, with_backtrace, and duplicate fresh_id ([#2726](https://github.com/jeong-sik/oas/issues/2726)) ([b15690f](https://github.com/jeong-sik/oas/commit/b15690fc64237dbdc20e857c6855addacce72008))
...
`v0.225.0...v0.226.0` contains one commit — the release commit itself ([#2814](https://github.com/jeong-sik/oas/issues/2814)). No library change shipped in this version.

The generated body previously listed ~292 pull requests reaching back to `#10`, all of them already described in the sections below. `v0.224.0` and `v0.225.0` were tagged by hand inside feature PRs ([#2813](https://github.com/jeong-sik/oas/issues/2813), [#2815](https://github.com/jeong-sik/oas/issues/2815)) rather than by release-please, and neither tag has a GitHub Release object, so release-please resolved its previous release as `v0.223.2` and regenerated everything after it. Release sections and version bumps are written by release-please only; feature PRs append under `## Unreleased`.
