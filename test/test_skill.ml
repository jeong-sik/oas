  ...
  run "Skill" [
    ...
    "show", [
      ...
      test_case "show_t" `Quick (fun () ->
        ...
        check bool "non-empty" true
          (String.length (Skill.show skill) > 0));
    ];
  ]
